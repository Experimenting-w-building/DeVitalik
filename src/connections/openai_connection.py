            ...
            "generate-embeddings": Action(
                ...
                parameters=[
                    ActionParameter(
                        ...
                        True,
                        list,
                        "The list of chunks to create embeddings for.",
                    )
                ],
            ...
            if model == "o3-mini":
                ...
                completion = client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "user",
                            "content": f"Formatting re-enabled. {prompt}. Here is a developer prompt to help you make an answer: {system_prompt}.",
                        },
                    ],
                )
    ...
    def generate_embeddings(self, chunks: list, model: str = None):
        ...
        try:
            ...
            for index, chunk in enumerate(chunks):
                try:
                    logger.debug(
                        f"Processing chunk index {index}: {chunk[:100]}..."
                    )  # Log part of the chunk
